...
namespace peliculasAPI.Utilidades
{
    public class AutoMapperProfiles: Profile
    {
        ...
        private List<PeliculasGeneros> MapearPeliculasGeneros(
                PeliculaCreacionDTO peliculaCreacionDTO, Pelicula pelicula)
        {
        ...
        private List<PeliculasCines> MapearPeliculasCines(
                PeliculaCreacionDTO peliculaCreacionDTO, Pelicula pelicula)
        {
